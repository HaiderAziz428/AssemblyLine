  ...
  return (
    <footer className="bg-black text-white pt-12 pb-6 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row justify-between gap-8 mb-8">
          ...
          <div className="max-w-md">
            <div className="flex items-center mb-4">
              <div className="relative h-10 w-10 mr-2 flex-shrink-0" aria-hidden="true">
            ...
            <p className="text-zinc-400 mb-4">
              Professional automotive services with cutting-edge technology and expert technicians for all your vehicle needs.
            </p>
            <a
              href={BUSINESS.mapsUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-start gap-2 group w-fit"
              aria-label="View our location on Google Maps"
            >
              <MapPin className="h-5 w-5 mt-0.5 text-zinc-400 group-hover:text-gold-500 transition-colors flex-shrink-0" aria-hidden="true" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              ...
              <ul className="space-y-2" role="list">
                {["Electrical Services", "Mechanical Repairs", "AC Service & Repair", "Oil Change Service"].map((s) => (
                  <li key={s}>
            ...
            {/* Hours */}
            <div>
              <h3 className="text-lg font-bold mb-4 text-white">Working Hours</h3>
              <ul className="space-y-2 text-zinc-400" role="list">
            ...
            <div>
              ...
              <div className="mt-6 space-y-1">
                <a
                  ...
                  className="block text-zinc-400 hover:text-gold-400 transition-colors text-sm"
                >
                  {BUSINESS.phone}
                </a>
                <a
        ...
        {/* Copyright */}
        <div className="border-t border-navy-800 pt-6 flex flex-col sm:flex-row items-center justify-between gap-2 text-sm text-zinc-500">
          <p>&copy; {currentYear} Assembly Line Car Workshop. All rights reserved.</p>
