...
import { Clock, ThumbsUp, PenToolIcon as Tool, Shield, DollarSign, Award } from "lucide-react"
...
export default function WhyChooseUs() {
  ...
  const reasons = [
    {
      ...
      description: "We value your time and work efficiently to get you back on the road quickly.",
    },
    {
      icon: <ThumbsUp className="h-10 w-10 text-gold-500" />,
      title: "Customer Satisfaction",
      description: "Our 5-star reviews speak for themselves. We prioritize your satisfaction.",
    },
    {
      icon: <Tool className="h-10 w-10 text-gold-500" />,
      title: "Advanced Equipment",
      description: "We use the latest diagnostic tools and equipment for accurate repairs.",
    },
    {
      icon: <Shield className="h-10 w-10 text-gold-500" />,
      title: "Warranty Protection",
      description: "All our repairs and services come with a comprehensive warranty.",
    },
    {
      icon: <DollarSign className="h-10 w-10 text-gold-500" />,
      title: "Competitive Pricing",
      description: "Quality service at fair prices with no hidden fees or surprises.",
    },
    {
      icon: <Award className="h-10 w-10 text-gold-500" />,
      title: "Certified Experts",
      description: "Our technicians are certified and continuously trained on the latest technologies.",
    },
  ]
  ...
  return (
    <section id="why-choose-us" className="py-20 relative overflow-hidden">
      ...
      <div id="why-choose-section" className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-zinc-400 max-w-2xl mx-auto">
            We're committed to providing exceptional service and building long-term relationships with our customers.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {reasons.map((reason, index) => (
            ...
            >
              ...
              <p className="text-zinc-400 group-hover:text-zinc-300 transition-colors">{reason.description}</p>
            </div>
          ))}
        </div>
      </div>
