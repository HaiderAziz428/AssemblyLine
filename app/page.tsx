...
export const metadata: Metadata = {
  title: "Assembly Line Auto Repair | Professional Car Services",
  description:
    "Expert automotive services including electrical, mechanical, AC work, and oil changes. Book your appointment today!",
  keywords: "car workshop, auto repair, mechanical services, oil change, AC repair, electrical services",
}
